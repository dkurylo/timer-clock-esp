...
"<html>"
  "<head>"
    ...
    "<style>"
      ...
      "#exw{width:100%;display:flex;background-color:#333;}"
      "#exd{width:68%;padding:2.1% 5.3%;line-height:0;}"
      "#exd>img{width:100%;image-rendering:pixelated;aspect-ratio:32/8;}"
      "#exl,#exr{width:22%;flex-wrap:wrap;align-content:center;justify-content:flex-end;display:none;}"
      "#exr{justify-content:flex-start;}"
      "#exl>div,#exr>div{aspect-ratio:1;border:0.3em solid #888;border-radius:50%;height:68%;}"
...
void handleWebServerGet() {
  ...
  "<div class=\"fx\">"
    ...
    "<div class=\"fi pl\"><div id=\"exw\"><div id=\"exl\"><div></div></div><div id=\"exd\"></div><div id=\"exr\"><div></div></div></div></div>"
...
"<script>"
  "function pw(){"
    ...
    "let exd=document.querySelector('#exd img');"
    "if(!exd){"
      "document.querySelector('#exd').innerHTML='<img src=\"'+src+'\">';"
    "}else{"
      "if(exd.src!=src)exd.src=src;"
    "}"
    "let rton=document.querySelector('#rt').checked;"
    "document.querySelector('#exl').style.display=rton?'flex':'';"
    "document.querySelector('#exr').style.display=rton?'':'flex';"
  "}"
